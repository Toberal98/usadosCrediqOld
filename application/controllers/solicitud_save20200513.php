...
class Solicitud_save extends CI_Controller {
    ...
    function guardar_sol_vehiculo() {
        ...
        <script type="text/javascript">
                ...
                var lName = "<?php echo $nombre ?>";
                var lDui = "<?php echo $dui ?>";
                var lEmail = "<?php echo $clientes['email']; ?>";
                var lPhone = "<?php echo $clientes['telefono_celular']; ?>";
                var lAuto = "<?php echo $clientes['tipo_vehiculo'] ?>";
                
                function selectCar(lAuto){
                    var lAutoSelected;
                    console.log('entre');
                    switch(lAuto) {
                        case lAuto:
                            lAutoSelected = "AUTOMÓVIL";
                            console.log(lAutoSelected);
                            break;
                        case lAuto:
                    ...
                    return lAutoSelected
                    
                }
                var lSelected = selectCar(lAuto);
                var lButtom = "Solicitud de Vehículo";
                ...
                $.ajax({
                        ...
                        "phone" : lPhone, "automovil": lSelected, "channel" : "web" },
                        type: "POST",
                        dataType: "json",
                        success: function (msg) {
                            ...
                            //alert(base_url);
                            var redirect = "/index.php/site/aviso/37";
