...
class User extends CI_Controller
{
	...
	function modificar($id){
		    ...
		    else
		{
			...
			//$data['modelo_favorito']=$this->data_model->getUsermodel($data['usuario']['modelo_favorito']);

			$data['modelos']=$this->filter_model->getModelsByMarck($data['usuario']['marca_favorita']);
