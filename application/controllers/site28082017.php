...
class Site extends CI_Controller {
    ...
    function index($tipo_venta = '1') {
        ...
        $consulta_sin_limite = $this->filter_model->getProducts(date('Y') - 11, date('Y'), '', '', '', '', 'todas', '', '', '', '','',0, "", $tipo_venta);
        $total_resultados = count($consulta_sin_limite);
        ...
        //Productos (Carros)
        $data['products'] = $this->filter_model->getProducts(date('Y') - 11, date('Y'), '', '', '', '', 'todas', '', '', '', $limite,'',0, "", $tipo_venta);
