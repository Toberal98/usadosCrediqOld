                    ...
                    <label><span>Marca:</span>
                        <select class="cabin_grey" name="marca" id="marca" onchange="getModels(this.value);" data-bvalidator="required">
                            ...
                            <?php foreach ($marcas as $marca): ?>
                                <option <?php if ($marca['id_marca'] == $car['id_marca']) {
                                echo 'selected="selected"';
                            } ?> value="<?php echo $marca['id_marca']; ?>"><?php echo $marca['nombre']; ?></option>
<?php endforeach ?>
                        </select>
			...
			-->
				<input type="hidden" id="color_in" name="color_in" value="<?php echo $car['color_interno']; ?>"/>
                   ...
                   <label><span><?php echo $tipo_venta == 2 ? 'Precio de contado' : ($tipo_venta == 3 ? 'Precio mínimo' :  'Precio') ?>:</span>
                            <input type="text" class="i_medium" name="precio" id="precio" value="<?php echo $car['precio']; ?>" data-bvalidator="number,required, minlength[3], maxlength[5]">
                   ...
                   <?php if($this->session->userdata('user_perfil')==1){ ?>
						   <p><span>Certificado</span> <label><input <?php if ('1' == $car['certificado']) {
							...
							<p><span>Recomendado</span> <label><input <?php if ('1' == $car['recomendado']) {
									echo 'checked';
								} ?> type="radio" name="recomendado" id="recomendado" value="1">Si</label> <label> <input <?php if ('0' == $car['recomendado']) {
									echo 'checked';
								} ?> type="radio" name="recomendado" id="recomendado" value="0">No</label></p>
					<?php }else{?>
					...
					<!--<label><span>Estado Veh&iacute;culo:</span>
                        <select class="cabin_grey" name="condiciones" id="condiciones" data-bvalidator="required">
							...
							<option <?php if('Excelente'== $car['Condiciones']){ echo 'selected="selected"'; } ?> value="Excelente">Excelente</option>
							<option <?php if('Muy Bueno'== $car['Condiciones']){ echo 'selected="selected"'; } ?> value="Muy Bueno">Muy Bueno</option>
							<option <?php if('Bueno'== $car['Condiciones']){ echo 'selected="selected"'; } ?> value="Bueno">Bueno</option>
							<option <?php if('Regular'== $car['Condiciones']){ echo 'selected="selected"'; } ?> value="Regular">Regular</option>
		...
		?>
            ...
            $('#imagen<?php echo $i?>').uploadify({
        		...
        		'onUploadSuccess' : function(file, data, response){
            		...
            		$('#previa<?php echo $i?>').html('<img width="58" height="58" src="<?php echo base_url().'public/img_autos_temp/' ?>'+nombre+'">');
...
if($v<=2){
            ...
            if(in_array('0000'.$v, $tipo_thumb)){//buscamos este codigo en el array
                          ...
                          echo '<li>
									...
									<p>' . $tipo_foto[$v] . '</p> 
									<input type="file" name="imagen" id="imagen'.$v.'"  ' . $requerido . ' style="display: none" > 
								</li>';
         ...
         ?>
                ...
                <input type="hidden" name="edit_user_car" id="edit_user_car" value="administrar" />
...
*/
                ...
                <div class="column12">
				 ...
				 foreach ($info_clientes as $info): ?>
                    ...
                    <label><span>Nombre:</span> <input type="text" name="ext_nombre" id="ext_nombre"  value="<?php echo $info['ext_nombre'];  ?>" data-bvalidator="required" />	</label>
                    <label><span>Email:</span> <input type="text" name="ext_email" id="ext_email" value="<?php echo $info['ext_email'];  ?>" data-bvalidator="required"  />
						...
						<input type="hidden" name="ext_email2" id="ext_email2"  value="<?php echo $info['ext_email'];  ?>" data-bvalidator="required" />
