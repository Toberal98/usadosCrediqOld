            ...
            <div class="column8">
                <h1>Cont&aacute;ctenos<span></span></h1>
                 <form action="<?php echo base_url(); ?>index.php/ajax/enviarMail" method="Post" id="solicitud-form" onsubmit="fillSpreadSheet()">
                    ...
                    <div class="form">
                        <label style="width:90%;"><span>Nombre:</span> <input onchange="this.form.nameCopy.value=this.value;" type="text" name="name" data-bvalidator="required"/></label>
                        <label style="width:90%;"><span>Dui/Identificación (Sin guiones):</span> <input onchange="this.form.duiCopy.value=this.value;" maxlength="9" type="text" name="dui" data-bvalidator="minlength[9],required"/></label><Br/>
                        <label><span>Email:</span> <input onchange="this.form.emailCopy.value=this.value;" type="text" name="email" data-bvalidator="email, required"/></label>
                        <label><span>Teléfono:</span> <input onchange="this.form.phoneCopy.value=this.value;"  type="text" name="phone"  data-bvalidator="number, required"/></label>
...
<!-- /*FIN - Modificado por: GGONZALEZ - 30/08/2016 */ -->
                    ...
                    <ul>
                        <li>Centro de Negocios CrediQ</li>
