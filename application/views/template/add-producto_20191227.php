        ...
        <div class="container12">
            <div class="row agregarNuevo">
                ...
                <div class="column6">
					...
					-->
					<input type="hidden" id="color_in" name="color_in" value=""/>
					
					
                    <label><span>Color :</span> <select class="cabin_grey" name="color_out" id="color_out" data-bvalidator="required">
                            <option value="">-Seleccione un Color-</option>
                            <?php foreach ($colors as $color): ?>
                                <option value="<?php echo $color['id_color']; ?>" ><?php echo $color['nombre']; ?></option>
                            <?php endforeach ?>
					...
					<?php if($this->session->userdata('user_perfil')==1){ ?>
								...
								<p><span>Recomendado</span> <label><input type="radio" name="recomendado" id="recomendado" value="1">Si</label> <label> <input type="radio" name="recomendado" id="recomendado" checked value="0">No</label></p>
					<?php }else{?>
