        ...
        <form action="<?php echo base_url(); ?>index.php/ajax/enviarMail" method="Post" id="solicitud-form" onsubmit="fillSpreadSheet()">
            ...
            <div class="form">
              ...
              <p>
                ...
                <label><span>Teléfono:</span> <input onchange="this.form.phoneCopy.value=this.value;" type="text" required maxlength="8" class="tel-info" id="phone" name="phone"  data-bvalidator="number, required"/></label>
                ...
                <input type="hidden" name="boton" value="Solicitarrrr Información">
