        ...
        <form action="<?php echo base_url(); ?>index.php/ajax/enviarMail" method="Post" id="solicitud-form">
            ...
            <div class="form">
              ...
              <p>
                ...
                <label style="width:90%;"><span>Nombre:</span> <input required type="text" name="name" data-bvalidator="required"/></label>
                <label><span>Email:</span> <input type="text" required name="email" data-bvalidator="email, required"/></label>
                <label><span>Teléfono:</span> <input type="text" required maxlength="8" name="phone"  data-bvalidator="number, required"/></label>
