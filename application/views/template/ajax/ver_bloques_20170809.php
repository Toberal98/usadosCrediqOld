...
<div class="column10">
    <ul class="car-list">
        ...
        foreach ($products as $car):
            ...
            <li>
                <figure><?php if ($car['certificado'] ==1 ): ?><div class="certificated"></div><?php elseif ($car['recomendado'] ==1 ): ?><div class="recomendado"></div><?php endif ?><a  href="<?php echo base_url() ?>car/ver/<?php echo $car['id_automovil'] . $string; ?>" onclick="event.preventDefault();
                ...
                <div class="bottom">
                    <?php if ($car['tipo_venta'] == '1'): ?>
                      <p class="price">Cuota desde: <?php echo $moneda . $car['cuotaMin']; ?><br/>
                          <em>Precio: <?php echo $moneda . number_format($car['precio'], 2, ".", ","); ?> </em></p>
                    <?php elseif ($car['tipo_venta'] == '2'): ?>
                      <p class="price">Precio de contado: <?php echo $moneda . number_format($car['precio'], 2, ".", ","); ?></p>
