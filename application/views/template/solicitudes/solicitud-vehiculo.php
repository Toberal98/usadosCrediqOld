        	...
        	<div class="column8">
              ...
              <p>
                ...
                <div class="formDatos">
                    ...
                    <label><span>Teléfono:</span> <input type="text" name="cli_telefono_fijo" id="cli_telefono_fijo"  class="tel-info"/></label>
                    <label><span>Celular *:</span> <input type="text" name="cli_telefono_celular" id="cli_telefono_celular"  class="tel-info"/></label>
                    <label><span>Teléfono Oficina:</span> <input type="text" name="cli_telefono_oficina" id="cli_telefono_oficina"  class="tel-info"/></label>
                    ...
                    <label style="display: none"><!-- Se deshabilito el checkbox 13/11/2019-->
                        <input type="checkbox"  name="cli_procedencia_importado" id="cli_procedencia_importado" value="1" checked/> Importado
                    </label>
