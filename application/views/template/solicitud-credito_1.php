...
<form id="form111" name="form111" method="post" action="<?php echo base_url() ?>index.php/solicitud_save/process_solicitud/" >
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>public/js/mask.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>public/js/jquery.limitkeypress.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            $(".number").limitkeypress({rexp: /^[+]?\d*\.?\d*$/});
        })
    </script>
    ...
    <div class="info_credito">
        ...
        <div>
            ...
            <div>
                ...
                <input type="text" name="ingreso" id="ingreso"  data-bvalidator="number,required" class="number"/><!-- ancho 300 -->	
            </div>
            <div class="clear_0"></div>
            <div>
                <label>*Comisiones(*): </label>
                <input type="text" name="comisiones" id="comisiones"  data-bvalidator="number,required" class="number"/>
            </div> 
            <div class="clear_0"></div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#n_doc").mask("99999999-9");
                $("#nit").mask("9999-999999-9999");
        ...
        <div class="asalariado" style="display:none;"><!--	asalariado -->
            ...
            <div>
                ...
                <input type="text" name="egresos" id="egresos" class="number"/>	
            </div>
        ...
        <div class="cargo">
            <div>
                ...
                <input type="text" name="cargo" id="cargo" data-bvalidator="minlength[3],required" />	
            </div>	
            <div class="clear_0"></div>

            <div>
                <label>Teléfono de Trabajo: </label>	
                <input type="text" name="telefono_tra" id="telefono_tra" maxlength="8" data-bvalidator="maxlength[8], minlength[8], number, required" class="number"/>	
            </div>		   
        </div>
        ...
        <div>
            ...
            <input type="text" name="valor_v" id="valor_v" data-bvalidator="number,required" class="number" value="<?php
            if (isset($car['precio'])) {
                echo $car['precio'];
            }
            ?>" />	
...
<?php endforeach ?>
        ...
        <div>
            ...
            if (isset($car['modelo'])) {
                ...
                $modelos = $ci->data_model->ModelosPorMarca($car['id_marca']);
                //echo $car['id_modelo'];
                ?>
                ...
                <select class="cabin_grey" name="modelo" id="modelo" data-bvalidator="required">
                    ...
                    <?php
                            foreach ($modelos as $modelo) {
                                ?>
                        <option value="<?php echo $modelo['id_modelo']; ?>" <?php
                        if ($modelo['id_modelo'] == $car['id_modelo']) {
                            echo ' selected="selected" ';
                        }
...
<?php endfor ?>
        ...
        <div>
            ...
            <select name="pais" id="pais" onchange="doNit(this.value)">
            <?php
            $nit = "";
        ...
        <div>
            ...
            if ($this->session->userdata('pais') == '2') {
                $doc = 'CEDULA';
                $nit = 'NIT';
            }
            ...
            <select name="documento" id="documento" onchange="ingresos(this.value)" style="float:left">
                <option>-Seleccione-</option> 
                <option id="doc_opc" value="<?php echo $doc; ?>"><?php echo $doc; ?></option>
        ...
        <div>
            ...
            <input type="text" name="n_doc" id="n_doc" data-bvalidator="required" /> 	
        </div>
        <div class="clear_0"></div>
        <div>
            <label id="t_doc"><?php echo $nit; ?>: </label>	
            <input type="text" name="nit" id="nit" data-bvalidator="required" /> 	
        </div>
        <div class="clear_0"></div>
        <div>
...
<?php } ?>
        ...
        <div>
            ...
            <input type="text" name="tel_fijo" id="tel_fijo" maxlength="8"  data-bvalidator="maxlength[8], minlength[8], number, required" class="number"/> 	
        </div>
        <div class="clear_0"></div>
        <div>
            <label>Teléfono Celular: </label>	
            <input type="text" name="tel_celular" id="tel_celular" maxlength="8" data-bvalidator="maxlength[8], minlength[8], number, required" class="number"/> 	
        </div>
        <div class="clear_0"></div>
        <div>
        ...
        <div>
            ...
            <input type="text" name="dependientes" id="dependientes" maxlength="2"  data-bvalidator="number, required" class="number"/>
        </div>
        <div class="clear_0"></div>
        <div>
...
<?php } ?>
        ...
        <div>
            <label>Nombres: </label>	
            <input type="text" name="ref_nombres" id="ref_nombres" data-bvalidator="alpha" />
        </div>
        <div class="clear_0"></div>
        <div>
            <label>Apellidos: </label>	
            <input type="text" name="ref_apellidos" id="ref_apellidos" data-bvalidator="alpha" />
        </div>
        <div class="clear_0"></div>
        <div>
            <label>Teléfono Casa: </label>	
            <input type="text" name="ref_telefono_casa" id="ref_telefono_casa" maxlength="8" data-bvalidator="number" class="number"/>
        </div>
        <div class="clear_0"></div>
        <div>
            <label>Teléfono de Trabajo: </label>	
            <input type="text" name="ref_telefono_trabajo" id="ref_telefono_trabajo" maxlength="8" data-bvalidator="number" class="number"/>
        </div>
        <div class="clear_0"></div>
        <div>
            <label>Teléfono Celular: </label>	
            <input type="text" name="ref_celular" id="ref_celular" value="" maxlength="8" data-bvalidator="number" class="number"/>
        </div>
        <div class="clear_0"></div>
        <div>
        ...
        <div class="separator_fields"></div>
        <span class="nota">
            <input type="checkbox" name="nota1" id="nota1" value="" data-bvalidator="required" />
            Autorizo a usadoscrediq.com a utilizar mi información personal para uso interno, tales como promociones, ofertas, etc.,
            siempre y cuando no comparta información con terceras personas.

            <br/>
            <br/>
            <input type="checkbox" name="nota2" id="nota2" value="" data-bvalidator="required" />
            No autorizo a usadoscrediq.com a utilizar mi información personal para ningún otro propósito más que para ser enviada a CrediQ 
            <br/>
            <br/>
            <input type="checkbox" name="nota3" id="nota3" value="" data-bvalidator="required" />Autorizo a GRUPO Q EL SALVADOR, S.A DE S.V., en adelante las "Las Empresas" para que consulten mi comportamiento crediticio para la 
            concesión de este crédito para efectos de análisis con entidades especializadas en la prestación de servicios de información o buros de
            crédito, incluyendo aquellas que recolecten, registran, procesan, distribuyen datos, referentes al comportamiento crediticio de las personas y 
            ofrecen servicios de información de base de datos.


        </span>

        <span class="nota">Nota: Al remitir esta solicitud autorizo
            al Banco para realizar consulta sobre mi referencia crediticia</span>
    ...
    <!-- http://usadoscrediq.com/fase2/index.php/solicitud/credito_natural/2  -->
    <input type="image" src="<?php echo base_url(); ?>public/images/enviar.jpg" style="height:22px" alt="Guardar"  id="guardar_prod">
    <div class="clear_0"></div>
</form>
<script type="text/javascript">
    $('#form111').bValidator();
