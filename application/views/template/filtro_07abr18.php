...
<aside class="column2 filters">
   ...
   <div id="slider-range-amount" class="slider-range"></div>
    ...
    <label for="hasta" class="amountcr">Precio en: <?php echo $moneda ?> <input type="text" id="amountcr" readonly /> </label>
   ...
   <label for="hasta" class="amounthn" >Precio en: <?php echo $moneda ?> <input type="text" id="amounthn" readonly /> </label>
