                ...
                <h1>Cont&aacute;ctenos<span></span></h1>
                 ...
                 <!-- <form action="<?php echo base_url(); ?>index.php/proccessContact" method="Post" id="solicitud-form"> -->
                    ...
                    <div class="form">
                        ...
                        <label><span>Teléfono:</span> <input type="text" name="phone"  data-bvalidator="number, required" class="tel-info"/></label>
                        <input type="hidden" name="bandera" id="bandera" value="2">
