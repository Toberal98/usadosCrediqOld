...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        if (isset($equipamiento)) {
            ...
            echo "Recuperar Clave CrediQ Usados";
        }
        ?>">
        ...
        if (isset($equipamiento)) {
            ...
            echo "Usados CrediQ® | Recuperar clave.";
        }
        ?>">
        ...
        <title> <?php echo (isset($car['modelo'])) ? (utf8_encode($car['marca'] . "-" . $car['modelo'])) : "Usados CrediQ® | Recuperar clave" ?></title>
...
/*foreach ($paises as $pais):*/
   ...
   $pais_sel = $this->session->userdata('pais');
                            ...
                            elseif ($pais_sel == 3) {
                              ...
                              $pais_arr = array(3 .' selected="selected"' => "Honduras", 1=>"El Salvador", 2=>"Costa Rica"); 
                              
                              }

                              elseif ($this->session->userdata('pais') == 1) {

                              $pais_arr = array(1 .' selected="selected"' => "El Salvador", 2=>"Costa Rica", 3=>"Honduras");
                              
                              }
                              
                              elseif ($this->session->userdata('pais') == 2) {

                              $pais_arr = array(2 .' selected="selected"' => "Costa Rica",1=>"El Salvador", 3=>"Honduras");
...
?>
                        ...
                        <?php  }  ?>
                            ...
                            ?>
                             <span class="phone">(+506) 4035-2400</span>
