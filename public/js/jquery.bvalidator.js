...
(function($){
	...
	bValidator = function(mainElement, overrideOptions){
		...
		var options = {
			...
			lang: 'es', 				// default language for error messages 
			...
			errorMessages: {
				en: {
					'default':    'Por favor corregir esta valor.',
					'equalto':    'Por favor inserte el mismo valor nuevamente.',
					'differs':    'Por favor digite un valor diferente.',
					'minlength':  'El campo debe tener no menos de {0} characters',
					'maxlength':  'El campo debe tener como maximo {0} characters',
					'rangelength':'The length must be between {0} and {1}',
					'min':        'Please enter a number greater than or equal to {0}.',
					'max':        'Please enter a number less than or equal to {0}.',
					'between':    'Please enter a number between {0} and {1}.',
					'required':   'Este campo es requerido.',
					'alpha':      'Por favor solo caracteres alfabeticos.',
					'alphanum':   'Por favor solo caracteres alfanumericos.',
					'digit':      'Please enter only digits.',
					'number':     'Por favor digite un numero valido.',
					'email':      'Por favor digite una direccion de email valida.',
					'image':      'Este campo solo puede contener los tipos de imagenes',
					'url':        'Por favor inserte una URL valida.',
